...
class SensorData {
  ...
  factory SensorData.fromJson(Map<String, dynamic> json) {
    ...
    final isikAnalogRaw = i(['Isik_Analog', 'isik_analog', 'light_analog']);
    final isikLux = d(['Isik_Lux', 'isik_lux', 'light_lux']);
    final isikAnalogFromLux = isikLux == null
        ? null
        : (isikLux / 15000.0 * 4095.0).clamp(0.0, 4095.0).round();

    return SensorData(
      tOrtam: d(['T_ortam', 't_ortam', 'sicaklik_ortam']) ?? 23.5,
      hOrtam: d(['H_ortam', 'h_ortam', 'nem_ortam']) ?? 62.0,
      tSu: d(['T_su', 't_su', 'sicaklik_su']) ?? 21.8,
      suMesafe: d(['Su_Mesafe_cm', 'su_mesafe_cm', 'su_mesafe']) ?? 14.0,
      isikAnalog: isikAnalogRaw ?? isikAnalogFromLux ?? 2048,
    );
  }
